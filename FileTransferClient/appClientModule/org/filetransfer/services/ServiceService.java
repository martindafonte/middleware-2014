 ...
 * 
 */
@WebServiceClient(name = "ServiceService", targetNamespace = "http://services.filetransfer.org/", wsdlLocation = "http://localhost:8080/WebFileTransferService/Service?wsdl")
    ...
    extends Service
{
    ...
    private final static QName SERVICESERVICE_QNAME = new QName("http://services.filetransfer.org/", "ServiceService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://localhost:8080/WebFileTransferService/Service?wsdl");
    ...
    public ServiceInterface getServicePort() {
        return super.getPort(new QName("http://services.filetransfer.org/", "ServicePort"), ServiceInterface.class);
    }
     ...
     */
    @WebEndpoint(name = "ServicePort")
    public ServiceInterface getServicePort(WebServiceFeature... features) {
        return super.getPort(new QName("http://services.filetransfer.org/", "ServicePort"), ServiceInterface.class, features);
    }
